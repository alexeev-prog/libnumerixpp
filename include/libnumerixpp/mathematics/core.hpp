...
namespace mathematics {
	 ...
	 *also 'another' approximation: anotherApproximatePower()). This method is based
	 *on the algorithm used in the 2005 game Quake III Arena. He raised the number x
	 *to the power -0.5, i.e. found the value: \f$\frac{1}{\sqrt{x}}\f$
	 *
	 ...
	 *degree increases and remains acceptable in the range [-10, 10] (see also 'old'
	 *approximation: oldApproximatePower()).
	 *
	 * @param[in]  base		 The base
	 * @param[in]  exponent	 The exponent
	 *
	 ...
	 *Speed increase: ~7.5 times on average, the advantage remains until the numbers
	 *are raised to the power of 134217728. Error: none, but it is worth noting that
	 *the multiplication operation is not associative for floating point numbers,
	 *i.e. 1.21 * 1.21 is not the same as 1.1 * 1.1 * 1.1 * 1.1, however, when
	 *compared with standard functions, errors do not arise, as mentioned earlier.
