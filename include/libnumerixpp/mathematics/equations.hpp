...
/**
 * @brief	   Function for solving equations by the method of half division.
 *
 * @details	   The half division method for solving an algebraic equation of the
 *			   form f(x) = 0 implies that the sought root is localized in the
 *			   interval a <= x <= b, and at the boundaries of the root search
 *			   interval the function f(x) must take values of different signs
 *			   (which can be written as the condition f(a)f(b) < 0).
 *
...
/**
 * @brief	   Function f for determining the right side of solved equations (half division)
 *
 * @param[in]  x	 x value
 *
 * @return	   value
...
/**
 * @brief	   Function g for determining the right side of solved equations (half division)
 *
 * @param[in]  x	 x value
 *
 * @return	   value
...
/**
 * @brief	   Function h for determining the right side of solved equations (half division)
 *
 * @param[in]  x	 x value
 *
 * @return	   value
